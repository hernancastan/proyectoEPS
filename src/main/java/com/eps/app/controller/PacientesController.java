...
public class PacientesController implements Serializable {
    ...
    @EJB
    private com.eps.app.facade.PacientesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("PacientesCreated"));
